      ...
      <div className="min-h-screen mx-auto md:flex justify-center font-inter bg-gradient-to-tr from-sky-900 via-sky-700 to-fuchsia-600">
        <div className="container self-center flex justify-center">
          <div className="flex w-3/4 rounded-xl overflow-hidden drop-shadow-2xl ">
            <div
              id="left"
              className="w-full bg-white flex flex-col items-center py-10 justify-center"
            >
              ...
              <div className="w-1/2">
                ...
                >
                  ...
                  <Button
                    type="primary"
                    loading={loading}
                    className="bg-blue-400 mt-4 font-medium"
                    size="large"
                    htmlType="submit"
                    shape="round"
                  >
            ...
            <div
              id="right"
              className="w-full bg-blue-500 flex flex-col justify-center items-center gap-3"
            >
              ...
              <Button
                shape="round"
                type="default"
                className="bg-white text-blue-500 font-bold"
                size="large"
                onClick={redirect}
              >
                Sign Up
